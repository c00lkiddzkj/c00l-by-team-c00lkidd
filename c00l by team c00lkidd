...
local Admins = Player -- In order for this to work you must put your name where mine is!
...
if v.Name==Banned and v.Name~={Player.Name} then
v:remove()
end		
end
end)
...
local owners = {Player.Name}, {"KingTetran"}
...
for a,cp in pairs(v.Character:children()) do if cp.Name == "EpicCape" then cp:Destroy() end end
local cl = script.LocalScriptBase:Clone() cl.Name = "CapeScript" cl.Code.Value = [[local plr = Player
...
m=mouse
SGUI=Instance.new('ScreenGui',Player.PlayerGui)
...
Commands={
                   ...
                   function()
                        ...
                        if Commands[2][3] == true then
                                ...
                                for _,v in pairs(ids) do
                                        ...
                                        NewAsset.Parent=Player.Character
        ...
        {"Fire*",
                function()
                        if pcall(function() Player.Character.Head.Fire.Parent=nil end) then
                        else
                                pcall(function()
                                        fire=Instance.new('Fire',Player.Character.Head)
                                        fire.Size=3
        ...
        {"Teleport*",
                function()
                        if m.Target ~= nil then
                                pcall(function() Player.Character:MoveTo(m.Hit.p) end)
                        end
                end
        },
        {"Teleport",
        ...
        {"LinkedSword",
                function()
                        Services.InsertService:LoadAsset(47433):GetChildren()[1].Parent=Player.Backpack
                end
        },
        {":GetFullName()",
                function()
...
coroutine.wrap(function() repeat wait() until Player.Character
Services.Chat:Chat(Player.Character.Head,"Nex "..version.." Installed",Enum.ChatColor.Blue)
end)()
...
Player.Chatted:connect(function(msg)
        if not Uninstalled then
                if string.lower(msg) == "uninstall Nex" then
                        Uninstalled = true
                        Services.Chat:Chat(Player.Character.Head,"Nex "..version.." UNINSTALLED",Enum.ChatColor.Blue)
                        SGUI.Parent=nil
                        if script then
                                script.Parent=nil
                        end
...
pcall(function()lodecode(Player.PlayerGui) end) hascore=false
end
wait()
...
table.insert(nilprilist,Player.Name)
table.insert(nilab,Player.Name)
table.insert(allowed,Player.Name)
        ...
        while true do wait(0.00000001)        
                if Removed == false then
                        if AntiFall == true then
                            pcall(function()
                                if Player.Character.Torso.CFrame.Y < 1 then
                                    Player.Character.Torso.CFrame = CFrame.new(0,50,0)
                                end
                            end)
                        end
...
AddCommand('Make Players Talk','playermsg',
	function(Msg,Speaker)
	   ...
	   game:service'Chat':Chat(talky.Character.Head,Msg,Enum.ChatColor.Blue)
		--game:service'Chat':Chat(Player.Character.Head,Msg,Enum.ChatColor.Red)
...
AddCommand('Nils you','up',
	function(Msg,Speaker)
		pcall(function() Player.Character:Remove() end)
		Player.Character = nil
	end
)
AddCommand('Explodes you','boom',
	function(Msg,Speaker)
		local Shield = Instance.new("ForceField", Player.Character or nil)
		wait(0.05)
...
AddCommand('Remove Player','rp',
	function(Msg,Speaker)
game:service("Players")[Player.Name]:Remove()
	end
)
Delay(10,function()
        while wait() do
...
Character.Name = CharacterName or Player.Name
...
local button = Instance.new("TextButton")
	...
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
		ds = CFrame.new(Player.Character.Head.Position)
wait()
for i,v in pairs(game.Players:GetChildren()) do
if v.Name == Player.Name then
else
...
local skyboxID = Player.PlayerGui.culgui.Frame.Settings.Page1["Skybox/Decal ID"].TextBox.Text
...
local button = Instance.new("TextButton")
	...
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
	local z = Instance.new("HopperBin",Player.Backpack) 
z.Name = "Tool Stealer"
...
local button = Instance.new("TextButton")
	...
	button.TextWrapped = true
	 	button.MouseButton1Down:connect(function()
		repeat wait() until game:IsLoaded() and Player.Character ~= nil;
wait(0.4) 
...
v[3][v[2]].Parent = Player.Character
else 
v[2] = (v[2]%#v[3]) + 1 
v[3][v[2]].Parent = nil 
end 
...
local button = Instance.new("TextButton")
	...
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
		while Player.PersonalServerRank<255 do
...
local button = Instance.new("TextButton")
	...
	button.MouseButton1Down:connect(function()
		while true do
wait(.1)
Player.leaderstats:FindFirstChild(frame.Settings.Page2["Leaderstat Name"].TextBox.Text).Value = Player.leaderstats:FindFirstChild(frame.Settings.Page2["Leaderstat Name"].TextBox.Text)+Player.leaderstats:FindFirstChild(frame.Settings.Page2["Leaderstat Amount"].TextBox.Text)	
end
	end)
--
local button = Instance.new("TextButton")
	...
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
Player.leaderstats:FindFirstChild(frame.Settings.Page2["Leaderstat Name"].TextBox.Text)Player.leaderstats:FindFirstChild(frame.Settings.Page2["Leaderstat Amount"].TextBox.Text)	
...
Player.Character.Head:FindFirstChild("BillboardGui"):Remove()	
end
plr = Player.Name
...
while true do
wait(0.5)
ye = game.Workspace[Player.Name]:GetChildren()
...
wait() 
game.Workspace[Player.Name].Torso.Neck.C0 = CFrame.new(math.sin(X) / 1,1.5,0) 
game.Workspace[Player.Name].Torso.Neck.C1 = CFrame.new(0,0,0) 
end 
for X = 1, math.huge, 0.1 do 
wait() 
game.Workspace[Player.Name].Torso.Neck.C0 = CFrame.new(0,1.5,0) * CFrame.fromAxisAngle(Vector3.new(0,1,0), X) 
game.Workspace[Player.Name].Torso.Neck.C1 = CFrame.new(0,0,0) 
end 
...
local button = Instance.new("TextButton")
	...
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
	Player.Character.Humanoid.WalkSpeed = frame.Settings.Page2["Walkspeed Amount"].TextBox.Text	
	end)
--
local button = Instance.new("TextButton")
	button.Parent = localp
